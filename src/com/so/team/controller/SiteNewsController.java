...
public class SiteNewsController extends HttpServlet {
	...
	//添加保存
	protected void save(HttpServletRequest request, HttpServletResponse response, HttpSession session) throws ServletException, IOException {
		SiteNews siteNews = new SiteNews();
		 //这是上传到tomcat下，文件容易丢失
        ...
        try{
            ...
            for(FileItem item : list){
                ...
                if(item.isFormField()){
                    ...
                    siteNews.setPic("\\upload" + "\\" + filename);
                }
            }
